...
export default function App(props) {
    ...
    async function getData() {
        ...
        console.log(data)
        data = data.map(val => ({ transactions: transactions, changeTransactions: setTransactions, percentageChange: val.price_change_percentage_24h_in_currency, name: val.name, image: val.image, currentPrice: val.current_price }))
        setData(data)
